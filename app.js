...
const webRentsRoutes = require('./routes/web/management/rentsRoutes');
const webProfileRoutes = require('./routes/web/general/profileRoutes');
const webCompanyRoutes = require('./routes/web/general/companyRoutes');
